...
ALTER TABLE "hive"
ADD FOREIGN KEY("apiary_id") REFERENCES "apiary"("apiary_id")
ON UPDATE NO ACTION ON DELETE CASCADE;
ALTER TABLE "bee_community"
ADD FOREIGN KEY("hive_id") REFERENCES "hive"("hive_id")
ON UPDATE NO ACTION ON DELETE CASCADE;
ALTER TABLE "veterinary_passport"
ADD FOREIGN KEY("community_id") REFERENCES "bee_community"("community_id")
ON UPDATE NO ACTION ON DELETE CASCADE;
ALTER TABLE "veterinary_record"
ADD FOREIGN KEY("passport_id") REFERENCES "veterinary_passport"("passport_id")
ON UPDATE NO ACTION ON DELETE CASCADE;
ALTER TABLE "sensor"
ADD FOREIGN KEY("hive_id") REFERENCES "hive"("hive_id")
ON UPDATE NO ACTION ON DELETE CASCADE;
ALTER TABLE "sensor_reading"
ADD FOREIGN KEY("sensor_id") REFERENCES "sensor"("sensor_id")
ON UPDATE NO ACTION ON DELETE CASCADE;
